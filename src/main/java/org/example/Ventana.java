...
public class Ventana extends JFrame {
    ...
    public Ventana(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(108, 15, 191, 255));
        lblId = new JLabel("ID:");
        ...
        panel2.setBackground(new Color(51, 220, 200));
        info = new ArrayList<>();
        info.add(new Videojuego(1, "Fifa", "Futbol", 300, "Multiplataforma", "EA Sports" ));
